...
export const GOOGLE_CLIENT_ID = '875164102794-pduegntn4j3q7u0qg7bodgn067i8l5oa.apps.googleusercontent.com';
export const GOOGLE_API_KEY = 'AIzaSyDmpkNhbSXKpTkcfq0ROLvGkb_wpXo1Qzg';
export const PRE_RENDER_TOKEN = 'Awz6QA4WTjPNMhfDFSdL';
export const GOOGLE_RECAPTCHA_SITE_KEY = window.location.origin.includes('slatteryauctions')
	? '6LeXJpgdAAAAAFa99aOgGWKdTydPMcGhBI2wASw5'
	: '6Lf1L4EaAAAAAGg91K0uW8zPdqeNbiKj0LVSROcB';
export const PAYPAL_CLIENT_ID = 'AV080b3FOHisowhtS1m7VQG6qT5r3J7P0vaW2W7Y0LiEmo2RYXsm2Q0b_xND_2iIs12YN6_SrAwvUu6H';
...
export const DEFAULT_IMAGE = 'https://s3.ap-southeast-2.amazonaws.com/slattery.sams-2022/slattery/Consignments/119901/Flx7TBFmEKOJJgq5pEQiiZmzPepdJ45e02QUurJB.jpg';
...
export const AUTH_REQ_PAGES = ['my-account', 'active-bid', 'profile', 'watching', 'items-won', 'payments', 'watchlist'];

export const carouselResponsive = ({ superLargeDesktop = 1, desktop = 1, tablet = 1, mobile = 1 }, partialVisibilityGutter) => ({
	superLargeDesktop: {
...
export const MESSAGES = {
	...
	ENQUIRY_SUBMIT: 'Thank you for getting in touch. One of our friendly team will be in touch soon.',
	...
	PLACE_BID_CURRENT_BID: 'Place Bid Amount should be more than current bid amount.',
	AUCTION_LOT_WON: 'You have won the auction of Lot No #',
	AUCTION_LAST_CALL: 'Last call for lot no',
	AUCTION_SUSPEND: 'Auction has been suspended due to some reason. It will be resumed soon.',
	...
	AUCTION_LOWER_BID: 'Lower Bid increment request sent to Admin successfully For',
	MOBILE_VERIFICATION: 'Mobile verification is mandatory to complete registration',
	CARD_FAILED: 'Card Verification Failed',
	SAVED_SEARCHED_MESSAGE: 'Please enter a name to save the search',
	THANKS_SUBSCRIBE: "Thank you for subscribing to Slattery Auction's newsletter",
	ACCOUNT_SUSPEND: 'Your account has been suspended. If you have any questions please contact your local team',
};
