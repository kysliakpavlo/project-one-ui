		...
		return (
			<div className="cmn-card">
						...
						<Col xs={6}>
							<div
								className={
									...
									assetInfo.currentBidAmount?.toString()
										.length >= 7
									...
									<Visible when={assetInfo.lotNo}>
										<div className="card-icons">
											<span className="sub-header">
												<SvgComponent path="emoji_transportation" />{' '}
												Lot: {assetInfo.lotNo}
											</span>
										</div>
									</Visible>
							...
							<div className="button-block">
								{assetInfo.assetType === ASSET_TYPE.BUY_NOW ? (
									<>
										...
										{assetInfo.status ===
											ASSET_STATUS.RELEASED && (
											<Button
												className="btn-outline-warning"
												onClick={() =>
													this.getUrlConstruct(true)
												}
											>
												{' '}
												<SvgComponent path="shopping-cart" />{' '}
									...
									<>
										{!isInRoom(
											assetInfo?.auctionData?.auctionType
												?.name
										) &&
											ASSET_LIST_TYPE.AUCTION_WINNING !==
												assetListType &&
				...
				<Visible when={showBidHistory}>
					<div
						className="bidHistory-expand-block"
						id="bidHistory-expand-block"
					>
						<Button
							variant="warning"
							className="close-btn"
